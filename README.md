...
```php
use App\Models\User;
use Filament\EditPageTester\EditPageTester;
...
use Filament\EditPageTester\Contracts\CustomFieldHandler;
use Filament\EditPageTester\FilamentSelector;
use Filament\Forms\Components\Field;
use Pest\Browser\Api\AwaitableWebpage;

class MyCustomFieldHandler implements CustomFieldHandler
{
    ...
    {
        $message = "Values are different after save for '$name'";
...
```php
use App\Tests\Support\MyCustomFieldHandler;

EditPageTester::make($current, $new)
    ->withCustomFieldHandler(new MyCustomFieldHandler())
    ->testSave();
```
...
- Created for use with [Filament v4](https://filamentphp.com)
- Built for [Pest PHP](https://pestphp.com) testing framework
- Inspired by real-world testing needs in production applications

## Support

If you discover any security vulnerabilities, please email [your-email@example.com](mailto:your-email@example.com) instead of using the issue tracker.

For bug reports and feature requests, please use the [GitHub issue tracker](https://github.com/yourusername/filament-edit-page-tester/issues).
